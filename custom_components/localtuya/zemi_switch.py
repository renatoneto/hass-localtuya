...
class LocalTuyaZemiSwitch(LocalTuyaEntity, SwitchEntity):
    ...
    async def async_turn_on(self, **kwargs):
        ...
        await self._device.set_dp("long_press", self._dp_id)
...
async_setup_entry = partial(async_setup_entry, DOMAIN, LocalTuyaZemiSwitch, flow_schema)
